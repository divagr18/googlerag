...
"{age}{gender}, {medical issue}, {location}, {policy duration}"
        ...
        You MUST WITHOUT FAIL use your search_insurance_clauses tool to find relevant insurance clauses from the knowledge base.
...
""",
    ...
    tools=search_insurance_clauses,
    stream_intermediate_steps =True,
    )
print("running agent")
start = time.perf_counter()

response: RunResponse = agent.run("46M, heart surgery, Pune, 3-month policy", markdown=True)
